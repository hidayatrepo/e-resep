  ...
  <div class="flex h-screen max-h-screen flex-1 bg-muted overflow-hidden">
    ...
    <aside id="sidebar" class="flex flex-col w-[280px] shrink-0 h-screen fixed inset-y-0 left-0 z-50 bg-white border-r border-border transform -translate-x-full lg:translate-x-0 transition-transform duration-300 overflow-hidden">
      ...
      <div class="flex items-center justify-between border-b border-border h-[90px] px-5 gap-3">
        ...
        <div class="flex gap-2">
          <button class="size-11 flex shrink-0 bg-white rounded-xl p-[10px] items-center justify-center ring-1 ring-border hover:ring-primary transition-all duration-300 cursor-pointer" aria-label="Cari">
            <i data-lucide="search" class="size-6 text-secondary"></i>
          </button>
          <button onclick="toggleSidebar()" aria-label="Tutup sidebar" class="lg:hidden size-11 flex shrink-0 bg-white rounded-xl p-[10px] items-center justify-center ring-1 ring-border hover:ring-primary transition-all duration-300 cursor-pointer">
          ...
          <div class="flex flex-col gap-1">
            ...
            <a href="#" class="group cursor-pointer">
              <div class="flex items-center rounded-xl p-4 gap-3 bg-white group-[.active]:bg-muted group-hover:bg-muted transition-all duration-300">
                ...
                <span class="font-medium text-secondary group-[.active]:font-semibold group-[.active]:text-foreground group-hover:text-foreground transition-all duration-300">Pasien</span>
              </div>
            </a>
            <a href="#" class="group cursor-pointer">
              <div class="flex items-center rounded-xl p-4 gap-3 bg-white group-[.active]:bg-muted group-hover:bg-muted transition-all duration-300">
                ...
                <span class="font-medium text-secondary group-[.active]:font-semibold group-[.active]:text-foreground group-hover:text-foreground transition-all duration-300">E-Resep</span>
              </div>
            </a>
            <a href="#" class="group cursor-pointer">
              <div class="flex items-center rounded-xl p-4 gap-3 bg-white group-[.active]:bg-muted group-hover:bg-muted transition-all duration-300">
                <i data-lucide="pill" class="size-6 text-secondary group-[.active]:text-foreground group-hover:text-foreground transition-all duration-300"></i>
                <span class="font-medium text-secondary group-[.active]:font-semibold group-[.active]:text-foreground group-hover:text-foreground transition-all duration-300">Obat</span>
              </div>
            </a>
            <a href="#" class="group cursor-pointer">
              <div class="flex items-center rounded-xl p-4 gap-3 bg-white group-[.active]:bg-muted group-hover:bg-muted transition-all duration-300">
                <i data-lucide="calendar-check" class="size-6 text-secondary group-[.active]:text-foreground group-hover:text-foreground transition-all duration-300"></i>
                <span class="font-medium text-secondary group-[.active]:font-semibold group-[.active]:text-foreground group-hover:text-foreground transition-all duration-300">Janji Temu</span>
              </div>
            </a>
          </div>
        </div>
          ...
          <div class="flex flex-col gap-1">
            ...
            <a href="#" class="group cursor-pointer">
              <div class="flex items-center rounded-xl p-4 gap-3 bg-white group-[.active]:bg-muted group-hover:bg-muted transition-all duration-300">
                ...
                <span class="font-medium text-secondary group-[.active]:font-semibold group-[.active]:text-foreground group-hover:text-foreground transition-all duration-300">Pengaturan</span>
              </div>
            </a>
          </div>
        </div>
      ...
      <div class="absolute bottom-0 left-0 w-[280px]">
        <div class="flex items-center justify-between border-t bg-white border-border p-5 gap-3">
          ...
          <button onclick="logout()" class="size-11 bg-red-50 rounded-xl flex items-center justify-center flex-shrink-0 hover:bg-red-100 transition-all cursor-pointer" aria-label="Keluar">
    ...
    <main class="flex-1 lg:ml-[280px] flex flex-col bg-white min-h-screen overflow-x-hidden">
      ...
      <div class="flex items-center justify-between w-full h-[90px] shrink-0 border-b border-border bg-white px-5 md:px-8">
        <!-- Mobile hamburger -->
        <button onclick="toggleSidebar()" aria-label="Buka menu" class="lg:hidden size-11 flex items-center justify-center rounded-xl ring-1 ring-border hover:ring-primary transition-all duration-300 cursor-pointer">
        ...
        <!-- Right actions -->
        <div class="flex items-center gap-3">
          <button class="size-11 flex items-center justify-center rounded-xl ring-1 ring-border hover:ring-primary transition-all duration-300 cursor-pointer relative" aria-label="Notifikasi">
          ...
          <div class="hidden md:flex items-center gap-3 pl-3 border-l border-border">
            ...
            <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=100&h=100&fit=crop" alt="Profile" class="size-11 rounded-full object-cover ring-2 ring-border">
          </div>
        </div>
      </div>
      ...
      <div class="flex-1 overflow-y-auto p-5 md:p-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 md:mb-8">
          <div>
            ...
            <p class="text-secondary text-sm md:text-base">Selamat datang! Berikut ringkasan aktivitas resep elektronik Anda hari ini.</p>
          </div>
          <div class="flex items-center gap-2 md:gap-3 ml-auto md:ml-0">
            ...
            <button onclick="newPrescription()" class="flex items-center gap-2 px-4 py-2.5 bg-primary text-white rounded-button font-medium hover:bg-primary-hover transition-all duration-200 cursor-pointer">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          <div class="flex flex-col rounded-2xl border border-border p-6 gap-3 bg-white">
            <div class="flex items-center gap-[6px]">
              ...
              <p class="font-medium text-secondary">Stok Obat Rendah</p>
            </div>
            <div class="flex items-center gap-3">
              <p class="font-bold text-[32px] leading-10">7</p>
              <span class="text-error text-sm font-semibold">Perhatian</span>
            </div>
          </div>
        </div>
            ...
            <div class="space-y-4">
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 py-3 border-b border-gray-100 last:border-0">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                  <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop" class="w-10 h-10 rounded-full object-cover flex-shrink-0" alt="Foto pasien">
                  <div class="min-w-0 flex-1">
                ...
                <div class="flex items-center gap-2 pl-13 sm:pl-0 sm:flex-shrink-0">
                  ...
                  <span class="bg-info-light text-info-dark text-xs font-medium px-2 py-1 rounded-full whitespace-nowrap">Aktif</span>
                </div>
              </div>
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 py-3 border-b border-gray-100 last:border-0">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                  <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop" class="w-10 h-10 rounded-full object-cover flex-shrink-0" alt="Foto pasien">
                  <div class="min-w-0 flex-1">
                ...
                <div class="flex items-center gap-2 pl-13 sm:pl-0 sm:flex-shrink-0">
                  ...
                  <span class="bg-success-light text-success-dark text-xs font-medium px-2 py-1 rounded-full whitespace-nowrap">Selesai</span>
                </div>
              </div>
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 py-3 border-b border-gray-100 last:border-0">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                  <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop" class="w-10 h-10 rounded-full object-cover flex-shrink-0" alt="Foto pasien">
                  <div class="min-w-0 flex-1">
              ...
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 py-3 border-b border-gray-100 last:border-0">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                  <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop" class="w-10 h-10 rounded-full object-cover flex-shrink-0" alt="Foto pasien">
                  <div class="min-w-0 flex-1">
                ...
                <div class="flex items-center gap-2 pl-13 sm:pl-0 sm:flex-shrink-0">
                  ...
                  <span class="bg-warning-light text-warning-dark text-xs font-medium px-2 py-1 rounded-full whitespace-nowrap">Tertunda</span>
                </div>
              </div>
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 py-3 border-b border-gray-100 last:border-0">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                  <img src="https://images.unsplash.com/photo-1494790108755-2616b786d4d3?w=100&h=100&fit=crop" class="w-10 h-10 rounded-full object-cover flex-shrink-0" alt="Foto pasien">
                  <div class="min-w-0 flex-1">
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
                ...
                <div class="text-right flex-shrink-0">
                  ...
                  <span class="bg-warning-light text-warning-dark text-xs font-medium px-2 py-1 rounded-full">Besok</span>
                </div>
              </div>
              <div class="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
                <div class="flex items-center gap-3 min-w-0 flex-1">
            ...
            <div class="p-4 bg-error-light rounded-card border-l-4 border-error">
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-gray-500 text-xs mt-1">Interaksi Warfarin dan Amiodarone terdeteksi untuk pasien #124</p>
                </div>
              </div>
            </div>
            ...
            <div class="p-4 bg-success-light rounded-card border-l-4 border-success">
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-gray-500 text-xs mt-1">Semua tanda tangan elektronik terverifikasi untuk resep hari ini</p>
                </div>
              </div>
            </div>
          </div>
...
<div id="prescription-modal" class="fixed inset-0 bg-black/50 z-[100] hidden flex items-center justify-center p-4">
  <div class="bg-white rounded-card p-6 max-w-md w-full">
    <div class="flex items-center justify-between mb-6">
      ...
      <button onclick="closePrescriptionModal()" class="size-8 flex items-center justify-center rounded-lg hover:bg-gray-100 cursor-pointer">
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <textarea class="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white h-24" placeholder="Contoh: Minum 1 tablet 2x sehari setelah makan"></textarea>
      </div>
      ...
      <button onclick="submitPrescription()" class="w-full mt-6 px-4 py-3 bg-primary text-white rounded-button font-medium hover:bg-primary-hover transition-all duration-200 cursor-pointer">
        Buat Resep
      </button>
    </div>
  </div>
